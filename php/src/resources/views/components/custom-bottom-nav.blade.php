    ...
    <div class="w-full max-w-md px-4 pointer-events-auto">
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-2xl shadow-2xl shadow-blue-900/10 p-2 flex justify-around items-center">
            ...
            <a href="?tab=list"
                ...
                class="h-16 aspect-square flex flex-col items-center justify-center rounded-2xl transition-all duration-300 inline-flex">
            ...
            <a href="?tab=recipe"
                :class="activeTab === 'recipe' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
                class="h-16 aspect-square flex flex-col items-center justify-center rounded-2xl transition-all duration-300 inline-flex">
                <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="?tab=setting"
                :class="activeTab === 'setting' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'"
                class="h-16 aspect-square flex flex-col items-center justify-center rounded-2xl transition-all duration-300 inline-flex">
                <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
