                    ...
                    <div class="space-y-5">
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-200/60 dark:border-white/5">
                            <div class="space-y-5">
                                ...
                                <div>
                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 mb-1">Confirm Password</label>
